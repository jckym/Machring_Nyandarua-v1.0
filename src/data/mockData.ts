import { 
  ...
  Notification, TOTPerformance, User 
} from '@/types';
...
export const mockLocalMRs: LocalMR[] = [
  { id: 'mr-1', name: 'Nakuru Central MR', code: 'NK-001', county: 'Nakuru', subcounty: 'Nakuru East', location: 'Nakuru Town', managerId: 'mgr-1', managerName: 'John Kamau', totalTots: 5, totalFarmers: 120 },
  { id: 'mr-2', name: 'Nyeri Highland MR', code: 'NY-001', county: 'Nyeri', subcounty: 'Nyeri Central', location: 'Nyeri Town', managerId: 'mgr-2', managerName: 'Mary Wanjiku', totalTots: 4, totalFarmers: 95 },
  { id: 'mr-3', name: 'Eldoret Valley MR', code: 'EL-001', county: 'Uasin Gishu', subcounty: 'Eldoret East', location: 'Eldoret CBD', managerId: 'mgr-3', managerName: 'Peter Kipkoech', totalTots: 6, totalFarmers: 150 },
  { id: 'mr-4', name: 'Meru Highlands MR', code: 'MR-001', county: 'Meru', subcounty: 'Meru Central', location: 'Meru Town', managerId: 'mgr-4', managerName: 'Grace Muthoni', totalTots: 3, totalFarmers: 80 },
  { id: 'mr-5', name: 'Kisumu Lakeside MR', code: 'KS-001', county: 'Kisumu', subcounty: 'Kisumu Central', location: 'Kisumu CBD', managerId: 'mgr-5', managerName: 'James Odhiambo', totalTots: 5, totalFarmers: 110 },
  { id: 'mr-6', name: 'Nanyuki Plateau MR', code: 'NN-001', county: 'Laikipia', subcounty: 'Laikipia East', location: 'Nanyuki', managerId: 'mgr-6', managerName: 'Sarah Njeri', totalTots: 4, totalFarmers: 75 },
  { id: 'mr-7', name: 'Kitale Western MR', code: 'KT-001', county: 'Trans Nzoia', subcounty: 'Kitale', location: 'Kitale Town', managerId: 'mgr-7', managerName: 'David Wekesa', totalTots: 5, totalFarmers: 130 },
  { id: 'mr-8', name: 'Narok Mara MR', code: 'NR-001', county: 'Narok', subcounty: 'Narok North', location: 'Narok Town', managerId: 'mgr-8', managerName: 'Joseph Sankok', totalTots: 3, totalFarmers: 65 },
  { id: 'mr-9', name: 'Machakos Valley MR', code: 'MC-001', county: 'Machakos', subcounty: 'Machakos Central', location: 'Machakos Town', managerId: 'mgr-9', managerName: 'Ruth Mwikali', totalTots: 4, totalFarmers: 90 },
  { id: 'mr-10', name: 'Kericho Tea Belt MR', code: 'KC-001', county: 'Kericho', subcounty: 'Kericho Central', location: 'Kericho Town', managerId: 'mgr-10', managerName: 'Moses Langat', totalTots: 4, totalFarmers: 100 },
];
...
export const mockFarmers: Farmer[] = [
  { id: 'farmer-1', name: 'Peter Kamau', phone: '+254711100001', email: 'peter.kamau@email.com', age: 45, location: { village: 'Bahati', ward: 'Bahati', subcounty: 'Nakuru East', county: 'Nakuru' }, localMrId: 'mr-1', localMrName: 'Nakuru Central MR', farmingActivity: 'Crop Farming', valueChain: 'Maize', farmerCategory: 'Pioneer', farmerRating: 'High-Value', registeredBy: 'tot-1', totalPurchases: 25, mechanisationCount: 8, trainingsAttended: 12, visitsCount: 6, createdAt: new Date('2023-06-15'), lastActivityDate: new Date('2025-06-15') },
  { id: 'farmer-2', name: 'Mary Njeri', phone: '+254711100002', email: 'mary.njeri@email.com', age: 38, location: { village: 'Subukia', ward: 'Subukia', subcounty: 'Nakuru East', county: 'Nakuru' }, localMrId: 'mr-1', localMrName: 'Nakuru Central MR', farmingActivity: 'Mixed Farming', valueChain: 'Dairy', farmerCategory: 'Existing', farmerRating: 'Active', registeredBy: 'tot-1', totalPurchases: 15, mechanisationCount: 5, trainingsAttended: 8, visitsCount: 4, createdAt: new Date('2023-08-20'), lastActivityDate: new Date('2025-06-10') },
  { id: 'farmer-3', name: 'John Maina', phone: '+254711100003', age: 52, location: { village: 'Nyeri Town', ward: 'Central', subcounty: 'Nyeri Central', county: 'Nyeri' }, localMrId: 'mr-2', localMrName: 'Nyeri Highland MR', farmingActivity: 'Coffee Farming', valueChain: 'Coffee', farmerCategory: 'Pioneer', farmerRating: 'High-Value', registeredBy: 'tot-3', totalPurchases: 30, mechanisationCount: 10, trainingsAttended: 15, visitsCount: 8, createdAt: new Date('2023-05-10'), lastActivityDate: new Date('2025-06-18') },
  { id: 'farmer-4', name: 'Grace Wangui', phone: '+254711100004', email: 'grace.wangui@email.com', age: 29, location: { village: 'Eldoret', ward: 'Pioneer', subcounty: 'Eldoret East', county: 'Uasin Gishu' }, localMrId: 'mr-3', localMrName: 'Eldoret Valley MR', farmingActivity: 'Wheat Farming', valueChain: 'Wheat', farmerCategory: 'New', farmerRating: 'Active', registeredBy: 'tot-5', totalPurchases: 5, mechanisationCount: 2, trainingsAttended: 3, visitsCount: 2, createdAt: new Date('2024-11-20'), lastActivityDate: new Date('2025-06-12') },
  { id: 'farmer-5', name: 'James Omondi', phone: '+254711100005', age: 41, location: { village: 'Kisumu CBD', ward: 'Milimani', subcounty: 'Kisumu Central', county: 'Kisumu' }, localMrId: 'mr-5', localMrName: 'Kisumu Lakeside MR', farmingActivity: 'Sugarcane Farming', valueChain: 'Sugarcane', farmerCategory: 'Existing', farmerRating: 'Dormant', registeredBy: 'tot-8', totalPurchases: 8, mechanisationCount: 3, trainingsAttended: 2, visitsCount: 1, createdAt: new Date('2023-12-05'), lastActivityDate: new Date('2025-02-10') },
];
...
export function getManagerStats() {
  return {
    ...
    pendingApprovals: mockMechanisationJobs.filter(j => j.status === 'pending-approval').length,
  };
}
...
export function getTOTPerformance(totId: string): TOTPerformance | null {
  const tot = mockTots.find(t => t.id === totId);
  if (!tot) return null;

  const localMr = mockLocalMRs.find(mr => mr.id === tot.localMrId);
  const commission = calculateTOTCommission(totId);
  const completedJobs = mockMechanisationJobs.filter(j => j.bookedBy === totId && j.status === 'completed');
  ...
  return {
    ...
    localMrName: localMr?.name || 'Unknown',
    status: tot.status,
    phone: tot.phone,
    email: tot.email,
    ...
    salesByProduct: commission.productBreakdown,
  };
}

export function getTOTsByLocalMR(localMrId: string): TOTPerformance[] {
  const totsInMr = mockTots.filter(t => t.localMrId === localMrId);
  return totsInMr.map(tot => getTOTPerformance(tot.id)!).filter(Boolean);
}
...
export function getLocalMRCommissionSummary(localMrId: string) {
  ...
  return {
    localMrId,
    localMrName: localMr?.name || 'Unknown',
    managerName: localMr?.managerName || 'Unknown',
    totalTots: totsPerformance.length,
    activeTots: totsPerformance.filter(t => t.status === 'active').length,
    totalSales: totsPerformance.reduce((acc, t) => acc + t.totalSales, 0),
    totalCommission: totsPerformance.reduce((acc, t) => acc + t.totalCommission, 0),
    tots: totsPerformance,
  };
}
