...
export function Header() {
  ...
  return (
    <header
      className="h-14 sm:h-16 bg-card/85 backdrop-blur-md border-b border-border/30 px-4 sm:px-6 flex items-center justify-between shadow-sm sticky top-0 z-40 supports-[backdrop-filter]:bg-card/85"
      role="banner"
    >
