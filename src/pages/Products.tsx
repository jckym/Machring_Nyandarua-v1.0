...
export function Products() {
  ...
  const getStockStatus = (stock: number) => {
    ...
    if (stock < 100) return { variant: 'warning' as const, label: 'Low Stock' };
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            {user?.role === 'admin' ? 'Manage product catalog and stock' : 'View product catalog'}
          </p>
        </div>
        {user?.role === 'admin' && (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <Card className="p-4" variant="forest">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold font-heading">{mockProducts.length}</p>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold font-heading text-accent-foreground">{formatCurrency(totalValue)}</p>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold font-heading text-amber-700">{lowStockProducts.length}</p>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold font-heading text-emerald-700">4</p>
          ...
          return (
            ...
            >
              ...
              <CardContent className="p-5">
                ...
                <p className="text-xs text-muted-foreground mt-4 line-clamp-2">{product.description}</p>
                
                {user?.role === 'admin' && (
                  <div className="mt-4 pt-4 border-t border-border flex gap-2">
                    <Button variant="outline" size="sm" className="flex-1">Edit</Button>
                    <Button variant="forest" size="sm" className="flex-1">Update Stock</Button>
                  </div>
                )}
              </CardContent>
            </Card>
