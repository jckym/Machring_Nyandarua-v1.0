...
export function Reports() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* Monthly Summary - Clean empty state */}
      <Card variant="gradient" className="p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="text-center text-muted-foreground">
            ...
            <p className="text-xs mt-1">Connect backend API to view live metrics</p>
          </div>
        </div>
      </Card>
      ...
      {/* Recent Downloads - Clean empty state */}
      <Card variant="elevated">
        ...
        <CardContent className="p-4 sm:p-6 pt-0">
          <div className="text-center py-12 text-muted-foreground">
            ...
            <p className="text-sm mt-2">Generate a report above to download it</p>
          </div>
        </CardContent>
      </Card>
    </div>
