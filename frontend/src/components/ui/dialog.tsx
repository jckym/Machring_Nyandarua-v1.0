...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] z-50 grid w-[calc(100%-2rem)] max-w-lg translate-x-[-50%] gap-4 border bg-background p-4 sm:p-6 shadow-lg duration-200",
        // Mobile-first: position from top with max-height for keyboard safety
        "top-[5%] max-h-[85vh] sm:top-[50%] sm:translate-y-[-50%] sm:max-h-[90vh]",
        // Scrollable content
